...
let UserResolver = class UserResolver {
    ...
    register(options, { dataSource, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userRepository = dataSource.getRepository(User_1.User);
            const user = userRepository.create(Object.assign(Object.assign({}, options), { password: hashedPassword }));
            try {
    ...
    login(usernameOrEmail, password, { dataSource, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userRepository = dataSource.getRepository(User_1.User);
            const user = yield userRepository.findOneBy(usernameOrEmail.includes("@")
    ...
    changePassword(token, newPassword, { redis, req, dataSource }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    forgotPassword(email, { redis, dataSource }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userRepository = dataSource.getRepository(User_1.User);
            const user = yield userRepository.findOneBy({
                email,
